...
CREATE TABLE `content` (
  ...
  `file_value` int(10) unsigned DEFAULT NULL,
  ...
  KEY `file_value` (`file_value`) USING BTREE,
  CONSTRAINT `block` FOREIGN KEY (`block_id`) REFERENCES `block` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `file_content` FOREIGN KEY (`file_value`) REFERENCES `file` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
-- Dump completed on 2013-09-12 11:28:37
