...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('resetCode')); ?>:</b>
	<?php echo CHtml::encode($data->resetCode); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('revertCode')); ?>:</b>
	<?php echo CHtml::encode($data->revertCode); ?>
	<br />
